...
./fonts/install.sh
#brew tap caskroom/fonts if needed replace with homebrew/cask-fonts
...
defaults write com.lightheadsw.Caffeine SuppressLaunchMessage -int 1;ok
